...
namespace Cybele.Thinfinity
{
    ...
    public class VirtualUI : VirtualUILibrary, IVirtualUI, IDisposable
    {
        ...
        private IVirtualUI m_VirtualUI;
        private IBrowserInfo m_BrowserInfo;
        private IDevServer m_DevServer;
        ...
        public IBrowserInfo BrowserInfo
        {
            get
            {
                return (IBrowserInfo)m_BrowserInfo;
            }
        }
